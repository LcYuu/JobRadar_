...
export default function TopListEmployers() {
  ...
  function CustomNextArrow(props) {
    const { onClick } = props;
    return (
      <button className="employer-custom-next-arrow" onClick={onClick} aria-label="Next">
  ...
  function CustomPrevArrow(props) {
    const { onClick } = props;
    return (
      <button className="employer-custom-prev-arrow" onClick={onClick} aria-label="Previous" disabled={props.currentSlide === 0}>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <section className="w-full py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8" style={{ color: "#43bfb3" }}>
