    ...
    >
      <CardContent className="p-6">
        <div className="flex flex-col h-full">
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-start lg:justify-between gap-2 mb-4">
            <div
              className="absolute top-4 right-4 p-1 rounded-md text-xs font-semibold uppercase hidden sm:block"
              style={{
                backgroundColor:
                  jobTypeColors[job.typeOfWork]?.backgroundColor ||
                  "rgba(0,0,0,0.1)",
                color: jobTypeColors[job.typeOfWork]?.color || "rgb(0,0,0)",
                border:
                  jobTypeColors[job.typeOfWork]?.border ||
                  "1px solid rgb(0,0,0)",
              }}
            >
              {job.typeOfWork}
            ...
            <div className="flex items-center w-full overflow-hidden">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-semibold text-lg group-hover:text-purple-600 transition-colors duration-300 line-clamp-1 sm:pr-20">
                ...
                <div
                  className="block sm:hidden p-1 rounded-md text-xs font-semibold uppercase mt-2"
                  style={{
                    backgroundColor:
                      jobTypeColors[job.typeOfWork]?.backgroundColor ||
                      "rgba(0,0,0,0.1)",
