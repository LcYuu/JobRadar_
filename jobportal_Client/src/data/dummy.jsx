import avatar from "../../src/assets/images/common/avatar.jpg";
export default{
    firstName:'James',
    lastName:'Carter',
    ...
    experience:[
        {
            ...
            '• Created RESTful APIs withNode.js and Express,facilitating data communicationbetween the front-end'+
